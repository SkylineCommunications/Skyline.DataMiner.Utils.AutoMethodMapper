namespace Skyline.DataMiner.Utils.AutoMethodMapper
{
    ...
    public sealed class MapperStringAttribute : Attribute
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MapperStringAttribute"/> class with the specified key.
        /// </summary>
        /// <param name="key">The key used to map the method.</param>
        public MapperStringAttribute(string key)
        {
            Key = key;
        }
